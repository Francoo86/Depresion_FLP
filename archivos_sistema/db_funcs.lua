...
local isnumber = function(number)
    return type(number) == "number"
end

local istable = function(tbl)
...
DBFuncs.Login.DBName = "psy_rework"
DBFuncs.Login.User = "root"
DBFuncs.Login.Password = "root"
DBFuncs:SetCurrentTable("THERAPISTS")

--- DBFuncs:CreateData({"Juanito", "Intergalactico", "Av. Cerro Dragon", "Iquique"})
-- DBFuncs:ReadData()
